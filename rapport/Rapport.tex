...
\newpage
\input{files/context.tex}

\newpage
\input{files/objectifs.tex}

\newpage
\input{files/prototypes.tex}

\newpage
\input{files/problemes.tex}

\newpage
\input{files/pedagogie.tex}

\newpage
\input{files/ouvertures.tex}

\newpage
\input{files/conclusion.tex}

\newpage
\input{files/biblio.tex}
\end{document}
